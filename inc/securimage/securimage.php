...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->wordlist_file = './words/harleyWords.txt';
    ...
    $this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		...
		$this->num_lines            = 20;
		$this->line_color           = new Securimage_Color(246, 139, 30);
		$this->draw_lines_over_text = false;

		$this->image_signature = 'NewOrleansHOG.com';
		$this->signature_color = new Securimage_Color(255, 139, 30);
